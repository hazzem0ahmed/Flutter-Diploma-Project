class SuggMovieApi {
  SuggMovieApi({this.status, this.statusMessage, this.data, this.meta});

  SuggMovieApi.fromJson(dynamic json) {
    status = json['status'];
  ...
  Data.fromJson(dynamic json) {
    ...
    if (json['movies'] != null) {
      ...
      json['movies'].forEach((v) {
        movies?.add(SuggestionMovies.fromJson(v));
      });
    }
  }

  num? movieCount;
  List<SuggestionMovies>? movies;
...
class SuggestionMovies {
  ...
  SuggestionMovies.fromJson(dynamic json) {
    id = json['id'];
    url = json['url'];

...
import 'package:movies/presentation/screens/tabs/explore_screen/api_manager.dart';
import 'package:movies/presentation/screens/tabs/explore_screen/api_manager.dart'
    as ApiManager;
import 'package:movies/presentation/screens/tabs/explore_screen/explore_cubit.dart';
    ...
    MultiBlocProvider(
      providers: [
        ...
        BlocProvider<ExploreCubit>(
          create: (context) => ExploreCubit(ApiClient(ApiManager.dio)),
        ),
      ],
    ...
    return BlocBuilder<LanguageViewModel, LocalizationState>(
      builder: (context, state) {
        return MaterialApp(
          ...
          initialRoute: ExploreTab.routeName,
        );
      },
    );
  }
